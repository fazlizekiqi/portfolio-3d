...
export const SLIDES = [
    ...
    {
        name: 'experience',
        // Rule-of-thirds: camera left, character occupies right ~2/3.
        // Low angle (camY below chest) pointing up to upper torso/head for presence.
        // dist=3.8 → mid-thigh to head visible (medium framing).
        // anchor:       { dist: 4.95 , camOffsetX:1 , camY: 0.95, targetOffsetX:-1.05, targetY: 1.45 },
        anchor: {dist: 4.95, camOffsetX: 1.6, camY: 0.85, targetOffsetX: -0.55, targetY: 1},
        mobileAnchor: {dist: 8.0, camOffsetX: -0.4, camY: 1.0, targetOffsetX: 0.1, targetY: 1.4},
        duration: 8000,
        camMoveDuration: 2200,
        easing: 'out',
        clip: 'idle',
        clipLoop: false,
        // x drift = slow horizontal parallax; z drift = subtle breathing zoom
