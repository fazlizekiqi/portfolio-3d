...
function _layout() {
  ...
  // Sensor stubs: a short line (≤60px) from each HUD panel's edge aimed at the
  // radar center, with a dot at the far end. Capped at 60px so they visually
  // point toward the rings without ever reaching the character.
