...
import {
  ...
  resetPresentBtn, setProgressFill, hideCard, showCard, hideWelcomeOverlay,
} from './ui.js';
...
presentBtn.addEventListener('click', () => { audio.resume(); audio.playButtonClick(); hideWelcomeOverlay(); _active ? _endPresentation() : _startPresentation(); });
